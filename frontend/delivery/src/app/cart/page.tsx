      ...
      <div className="max-w-4xl mx-auto container-padding section-spacing">
        ...
        <div className="mb-12">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            ...
            <Link
              href="/"
              className="inline-flex items-center gap-2 px-6 py-3 text-blood-red border-2 border-blood-red rounded-xl hover:bg-blood-red hover:text-white transition-all hover:scale-105 font-semibold"
            >
        ...
        {cart.length === 0 ? (
          ...
          <div className="bg-white rounded-3xl shadow-lg border border-gray-200 p-16 text-center">
            <div className="max-w-md mx-auto">
              ...
              <Link
                href="/"
                className="inline-flex items-center gap-3 bg-blood-red hover:bg-red-800 text-white px-10 py-4 rounded-xl font-bold text-lg transition-all hover:scale-105 shadow-lg hover:shadow-xl"
              >
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-3xl shadow-lg border border-gray-200 overflow-hidden sticky top-8">
                ...
                <div className="p-6">
                  ...
                  <button
                    className="w-full bg-blood-red hover:bg-red-800 text-white py-4 rounded-xl font-bold text-lg transition-all shadow-lg hover:shadow-xl hover:scale-105"
